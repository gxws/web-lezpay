...
<!-- begin head -->
<head>
<title> PT-BZ-11-支付系统公共帮助6 </title>
...
<!-- begin x_wrap -->
<div class="x_wrap pa" style="background-image:url(../static/web-lezpay/images/bg_x_help_12_0001.jpg);">

	<!-- begin x_steps -->
	<a href="javascript:;" class="x_step_finish pa"><img src="../static/web-lezpay/images/x_steps.png" /></a>
	<!-- end x_steps -->
