...
<div class="pa x_wrap">
	...
	<div class="">
	  ...
	  <!-- end header -->
	  <!-- begin container -->
		<div class="pa container k_box_p119" style="background-image:url(../static/web-lezpay/images/p62_0001_container.png)">
			<div class="pa codeBg"><img class="pa" width="245" height="245" src="../static/web-lezpay/images/demo_k_p119_01.jpg"/></div>
			<div class="pa text">使用手机扫码完成付款<em>{xxxx.xx}</em>元，并为您的支付宝账户授权在网视用户{注册手机号}开通支付功能。</div>
			<div class="pa text2">授权后小额支付无需再输入支付宝支付密码</div>
			<a class="pa btn over" href="./p119_k_02.php">
				<img src="../static/web-lezpay/images/btn_k_title_p119.png"/>
			</a>
			<a class="pa btn return" href="javascript:;">
				<img src="../static/web-lezpay/images/btn_k_title_p119_02.png"/>
			</a>
			<div class="pa tishi">温馨提示：若需取消授权，只需登录支付宝官网，在【账户设置】→【应用授<br/>权】进行操作即可。</div>
		</div>
	  <!-- end container -->
	</div>
	<!-- end DIY -->
