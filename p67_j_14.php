...
<!-- begin x_wrap -->
<div class="x_wrap pa j_cup" style="background-image:url(../static/web-lezpay/images/0001_pay_code.jpg);">
	...
	<form action="">
		<div class="cupbox_code">
			<a href="javascript:;" class="gain_code pa"><img src="../static/web-lezpay/images/0001_gain.png" /></a>
			<input type="text" class="input cup_code_input pa" size="6"/>
			<div class="error pa">错误提示信息区域！</div>
			<a href="javascript:;" class="cup_code_btn pa"><img src="../static/web-lezpay/images/x_btn_1.png" /></a>
		</div>
	</form>
</div>
<!-- end x_wrap -->
...
WS.base.help = 'p67_x_14.php';	//按帮助跳转的页面
</script>
-->
<!-- end javascript -->
