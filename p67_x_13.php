...
<!-- begin head -->
<head>
<title> PT-BZ-4-身份证后六位输入帮助页 </title>
...
<!-- begin x_wrap -->
<div class="x_wrap pa" style="background-image:url(../static/web-lezpay/images/bg_x_help_5_0001.jpg);">

	<!-- begin x_steps -->
	<a href="javascript:;" class="x_steps x_step_1 pa"><img src="../static/web-lezpay/images/x_steps.png" /></a>
