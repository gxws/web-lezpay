...
<!-- begin head -->
<head>
<title> 8.1.1.2.异常提示页-支付单不存在(P-LZ-3) </title>
...
<div class="x_wrap pa" style="background-image:url(http://10.1.15.50:7002/web-lezpay/images/bgc02.png);">
	<div class="x_date pa">05月09日</div>
    	<div class="x_lezpay_result">
			<a class="x_btn pa back" href="c03.php"><img src="http://10.1.15.50:7002/web-lezpay/images/x_0001_145_60.png"></a>
		</div>
</div>
