...
<div class="pa x_wrap">
	...
	<div class="">
	  ...
	  <!-- end header -->
	  <!-- begin container -->
		<div class="pa container k_box3_p119 c_p119box" style="background-image:url(../static/web-lezpay/images/p62_0001_containers.png)">
			<div class="pa txt a1">若在手机上已完成付款，</div>
			<a class="pa btn outcome" href="javascript:;">
				<img src="../static/web-lezpay/images/btn_c_p119_01.png"/>
			</a>
			<div class="pa txt a2">付款遇到问题，您可以</div>
