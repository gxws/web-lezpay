...
<!-- begin head -->
<head>
<title>PT-12-该支付单已完结-交易失效</title>
...
<!-- begin x_wrap -->
<div class="x_wrap pa" style="background-image:url(../static/web-lezpay/images/0001_pay_deal_lose.jpg);">

	<!-- begin x_date -->
	<div class="x_date pa">{05月09日}</div>
	<!-- end x_date -->
	<div class="j_deal_off j_t_info pa ">已付款项4000元已退还至您的乐众支付账户中</div>
	<!-- begin cont_title -->
	<div class="j_cont j_cont_title j_t_info pa">{【VIP购优汇】oneday正品大肚杯保温瓶情侣杯不锈钢男士女士水杯创意学生杯}</div>
	<!-- end cont_title -->
	<div class="j_cont j_cont_price j_t_info pa">价格：{40000}元</div>
	<!-- begin x_btns -->
	<a href="javascript:;" class="j_btns j_btn_1 pa"><img src="../static/web-lezpay/images/x_btn_1.png" /></a>
	<a href="javascript:;" class="j_btns j_btn_2 pa"><img src="../static/web-lezpay/images/x_btn_1.png" /></a>
	<!-- end x_btns -->
