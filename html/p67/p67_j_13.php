...
<!-- begin head -->
<head>
<title>PT-17-银联支付信息输入页-信用卡1</title>
...
<!-- begin x_wrap -->
<div class="x_wrap pa j_cup" style="background-image:url(../static/web-lezpay/images/0001_cup_credit1.jpg);">
	...
	<form action="">
		<div class="cupbox cupbox_savings2">
			...
			<input type="text" class="input cup_input text1 pa" size="4"/>
			<input type="text" class="input cup_input text2 pa" size="3"/>
...
WS.base.help = 'p67_x_11.php';	//按帮助跳转的页面
</script>
-->
<!-- end javascript -->
