...
<!-- begin x_wrap -->
<div class="x_wrap pa" style="background-image:url(../static/web-lezpay/images/0001_errors_bg.png);">

	<!-- begin x_date -->
	<div class="x_date pa">{05月09日}</div>
	<!-- end x_date -->
	<div class="pa error_text fs18 text-gray">请您稍后重试</div>
	<!-- begin x_btns -->
