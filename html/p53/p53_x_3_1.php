...
<!-- begin head -->
<head>
<title> 8.1.2.3.1.【失效状态】支付单完结(P-LZ-7) </title>
...
<div class="x_wrap pa" style="background-image:url(http://10.1.15.50:7002/web-lezpay/images/bg_x_wrap_x03_1.png);">
	<div class="x_date pa">05月09日</div>
	<div class="x_lezpay_result">
		<div class="desc pa">（失效时间14年3月18日 10:53）</div>
		<h1 class="pa">【VIP购优汇】oneday正品大肚杯保温瓶情侣杯不锈钢男士女士水杯创意学生杯</h1>
		<p class="pa">40000.50元&nbsp;<span>（已付款：12000.50元）</span></p>
		<a href="javascript:;" class="x_btn pa again"><img src="http://10.1.15.50:7002/web-lezpay/images/x_0001_145_60.png" /></a>
		<a href="javascript:;" class="x_btn pa back2"><img src="http://10.1.15.50:7002/web-lezpay/images/x_0001_145_60.png" /></a>
	</div>
</div>
