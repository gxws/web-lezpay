...
<!-- begin head -->
<head>
<title> 8.1.1.4.异常提示页-无权操作支付单(P-LZ-5) </title>
...
<div class="x_wrap pa" style="background-image:url(http://10.1.15.50:7002/web-lezpay/images/bgc04.png);">
	<div class="x_date pa">05月09日</div>
    	<div class="x_lezpay_result">
			<a class="x_btn pa back" href="c05.php"><img src="http://10.1.15.50:7002/web-lezpay/images/x_0001_145_60.png"></a>
		</div>
</div>
