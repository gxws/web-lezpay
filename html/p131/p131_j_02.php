	...
	<div class="j_zfb">
	  ...
	  <!-- begin container -->
		<div class="pa container k_box_p119 k_box2_p119 c_p119box" style="background-image:url(../static/web-lezpay/images/p62_0001_container.png)">
			<div class="pa tc h1 text-white">您还未完成付款！</div>
			<a class="pa btn sure" href="./p131_j_01.php">
				<img src="../static/web-lezpay/images/p131_0001_zfb_btn_06.png"/>
			</a>
			<a class="pa btn other" href="javascript:;">
				<img src="../static/web-lezpay/images/p131_0001_zfb_btn1_09.png"/>
			</a>
		</div>
	  <!-- end container -->
	</div>
