...
<div class="pa x_wrap">
	...
	<div class="">
	  ...
	  <!-- end header -->
	  <!-- begin container -->
		<div class="pa container k_box3_p119 c_p119box" style="background-image:url(../static/web-lezpay/images/p131_0001_zfb_bg1_02.jpg)">
			<div class="pa txts a1 fs18 text-white">支付宝未创建订单，</div>
			<a class="pa btn outcome" href="p119_c_02.php">
				<img src="../static/web-lezpay/images/p131_0001_zfb_btn_04.png"/>
			</a>
			<div class="pa txt a2">付款遇到问题，</div>
			<a class="pa btn turn" href="javascript:;">
				<img src="../static/web-lezpay/images/p131_0001_zfb_btn_07.png"/>
			</a>
		</div>
	  <!-- end container -->
	</div>
