...
<!-- begin x_wrap -->
<div class="x_wrap pa j_wrap" style="background-image:url(../static/web-lezpay/images/0001_pay_fail.jpg);">
	...
	<!-- begin x_btns -->
	<a href="javascript:;" class="btns x_btn_1 pa"><img src="../static/web-lezpay/images/x_btn_1.png" /></a>
	<div class="pa my_info fs20 tr">查看积分、余额或交易记录，请按</div>
	<a href="javascript:;" class="pa my_info_btn"><img src="../static/web-lezpay/images/c_btn.png" alt="" /></a>
	<!-- end x_btns -->
