...
<div class="pa x_wrap">
	...
	<div class="j_xzzj">
	  ...
	  <!-- end header -->
	  <!-- begin container -->
	  <div class="pa container" style="background-image:url(../static/web-lezpay/images/p62_0001_xzzj_bg.png)">
	  	<a href="javascript:;" class="pa l1 t1"><img src="../static/web-lezpay/images/p62_0001_xzzj_btn.png" alt="" width="172" height="100" /></a>
	  	<a href="javascript:;" class="pa l2 t1"><img src="../static/web-lezpay/images/p62_0001_xzzj_btn.png" alt="" width="172" height="100" /></a>
	  	<a href="javascript:;" class="pa l3 t1"><img src="../static/web-lezpay/images/p62_0001_xzzj_btn.png" alt="" width="172" height="100" /></a>
	  	<a href="javascript:;" class="pa l1 t2"><img src="../static/web-lezpay/images/p62_0001_xzzj_btn.png" alt="" width="172" height="100" /></a>
	  	<a href="javascript:;" class="pa l2 t2"><img src="../static/web-lezpay/images/p62_0001_xzzj_btn.png" alt="" width="172" height="100" /></a>
	  	<a href="javascript:;" class="pa l3 t2"><img src="../static/web-lezpay/images/p62_0001_xzzj_btn.png" alt="" width="172" height="100" /></a>
		</div>
	  <!-- end container -->
	</div>
	<!-- end DIY -->
