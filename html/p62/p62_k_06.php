...
<!-- begin head -->
<head>
<title>PT-42-快捷支付添加信用卡输入证件信息</title>
	  ...
	  <!-- begin container -->
		<div class="pa container" style="background-image:url(../static/web-lezpay/images/p62_0001_container.png)">
			<form class="k_form" id="J_k_form">
				<p class="err f18 pa" style="top:86px;left:140px;">错误提示信息区域！</p>
				<img class="pa" style="top:118px;left:248px;" src="../static/web-lezpay/images/k_01_btn_normal.png" />
				<div class="f18 pa" style="top:122px;left:325px;">选择证件</div>
				<a class="pa" style="top:119px;left:250px;" href="p62_k_07.php"><img src='../static/web-lezpay/images/k_01_btn_normal_ghost.png'/></a>
				<div class="f26 pa lftitle2" style="top:124px;">证件类型</div>
				<div class="f26 pa" style="top:124px;left:152px;">身份证</div>
				<div class="f26 pa lftitle2" style="top:182px;">真实姓名</div>
				<input class="pa" style="top:172px;left:140px;width:320px;" type="text"/>
