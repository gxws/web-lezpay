...
<div class="pa x_wrap">
	...
	<div class="">
	  ...
	  <!-- end header -->
	  <!-- begin container -->
	  <div class="pa container" style="background:url(../static/web-lezpay/images/p62_c_goingbuy.png) no-repeat;">
		 <div class="pa c_p62tips">
			<img src="../static/web-lezpay/images/0001_succeed.png" />
			<div class="pa lis">成功找回支付密码，</div>
			<div class="pa lit">下次支付请使用新密码！</div>
		 </div>
		 <a class="pa btnbuy" href="p62_c_01.php"><img src="../static/web-lezpay/images/btn_c_p62buy.png" /></a>
	  </div>
	  <!-- end container -->
	</div>
	<!-- end DIY -->
