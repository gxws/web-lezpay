	  ...
	  <!-- begin container -->
		<div class="pa container" style="background-image:url(../static/web-lezpay/images/p62_0001_container.png)">
			<form class="k_form" id="J_k_form">
				...
				<div class="f26 pa lftitle" style="top:90px;">原支付密码</div>
				<input class="pa" style="top:82px;left:192px;width:210px;" type="password"/>
				<img class="pa" style="top:88px;left:425px;" src="../static/web-lezpay/images/k_01_btn_small.png" />
				<div class="f18 pa" style="top:92px;left:438px;">找回支付密码</div>
				<a class="pa" style="top:86px;left:423px;" href="p62_k_11.php"><img src='../static/web-lezpay/images/k_01_btn_small_ghost.png'/></a>
				<div class="f26 pa lftitle" style="top:150px;">新支付密码</div>
				<input class="pa" style="top:144px;left:192px;width:210px;" type="password"/>
				<div class="pa f18" style="top:158px;left:427px;">最少6位,区分大小写</div>
				<div class="f26 pa lftitle" style="top:210px;">确认支付密码</div>
				...
				<div class="f26 pa" style="top:322px;left:250px;">确认修改</div>
