...
<!-- begin head -->
<head>
<title>PT-39-快捷支付添加信用卡成功结果</title>
...
<div class="pa x_wrap">
	...
	<div class="">
	  ...
	  <!-- end header -->
	  <!-- begin container -->
	  <div class="pa container" style="background:url(../static/web-lezpay/images/p62_c_backsle.png) no-repeat;">
		 <div class="pa c_p62tips">7
			<img src="../static/web-lezpay/images/0001_succeed.png" />
			<div class="pa lis">信用卡添加成功！</div>
		 </div>
		 <a class="pa btnback" href="p62_c_06.php"><img src="../static/web-lezpay/images/btn_c_p62back.png" /></a>
	  </div>
	  <!-- end container -->
	</div>
	<!-- end DIY -->
