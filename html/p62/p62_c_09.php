	...
	<div class="">
	  ...
	  <div class="pa container" style="background:url(../static/web-lezpay/images/p62_c_backlz.png) no-repeat;">
		 <div class="pa c_p62tips">
			...
			<div class="pa lis">登录密码修改成功，</div>
			<div class="pa lit">下次登录请使用新密码！</div>
		 </div>
		 <a class="pa btnre" href="p62_c_10.php"><img src="../static/web-lezpay/images/btn_c_p62re.png" /></a>
	  </div>
	  <!-- end container -->
	</div>
	<!-- end DIY -->
