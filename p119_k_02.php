...
<div class="pa x_wrap">
	...
	<div class="">
	  ...
	  <!-- end header -->
	  <!-- begin container -->
		<div class="pa container k_box_p119 k_box2_p119" style="background-image:url(../static/web-lezpay/images/p62_0001_container.png)">
			<div class="pa zhang">
				<div class="pa name">付款支付宝账户：</div>
				<div class="pa email">dakar******@gamil.comgamilgamilgamil</div>
			</div>
			<a class="pa btn sure" href="./p119_k_03.php">
