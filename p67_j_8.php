...
<!-- begin head -->
<head>
<title>PT-12-该支付单已完结-退款成功</title>
...
<!-- begin x_wrap -->
<div class="x_wrap pa" style="background-image:url(../static/web-lezpay/images/0001_pay_refund.jpg);">

	<!-- begin x_date -->
	<div class="x_date pa">{05月09日}</div>
	<!-- end x_date -->
	<div class="j_deal_off j_t_info pa ">4000元已退至您的乐众支付账户</div>
	<!-- begin cont_title -->
