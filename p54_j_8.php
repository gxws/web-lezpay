		...
		<div class="j_p54">
			<form method="post">
				<div class="j_plz17">
					...
					<div class="pa gain_name ps-topm">
						<p>短信验证码</p>
					</div>
					<div class="pa gain_text ps-topl">
						<p><input type="text" class="input input-sm" /></p>
						<p class="errors">错误提示区!</p>
					</div>
					<div>
						<a href="javascript:;" class="pa ps-topm gain">
							<img src="../static/web-lezpay/images/p54_j_001btn_03.jpg" alt="" width="120" height="39"/></a>
					</div>
