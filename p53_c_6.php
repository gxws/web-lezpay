...
<!-- begin head -->
<head>
<title>8.1.5.2.继续支付(P-LZ-11)</title>
...
<div class="x_wrap pa" style="background-image:url(http://10.1.15.50:7002/web-lezpay/images/bgc05.png);">
	...
	<div class="x_lezpay_result">
		...
		<p class="pa">40000.50元&nbsp;<span>（已付款：12000.50元）</span></p>
			<a class="pa c_btnsta" href="c07.php">
            	<img src="http://10.1.15.50:7002/web-lezpay/images/x_0001_530_60.png">
            </a>
			<div class="pa c_btn">确定，回到{应用名称}</div>
	</div>
</div>
