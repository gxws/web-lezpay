...
<!-- begin head -->
<head>
<title>PT-36-快捷支付输入支付密码-第一种</title>
	  ...
	  <!-- begin container -->
		<div class="pa container" style="background-image:url(../static/web-lezpay/images/p62_0001_container.png)">
			<form class="k_form" id="J_k_form">
				<p class="err f18 pa" style="top:95px;left:200px;">错误提示信息区域！</p>
				<div class="f26 pa lftitle" style="top:132px;">付款卡</div>
				<div class="f26 pa" style="top:132px;left:200px;">建设银行9558****5520（储蓄卡）</div>
				<div class="f26 pa lftitle" style="top:188px;">支付密码</div>
				<input class="pa" style="top:180px;left:192px;width:210px;" type="password"/>
				<img class="pa" style="top:186px;left:425px;" src="../static/web-lezpay/images/k_01_btn_small.png" />
				<div class="f18 pa" style="top:188px;left:438px;">找回支付密码</div>
				<a class="pa" style="top:184px;left:423px;" href="p62_k_03.php"><img src='../static/web-lezpay/images/k_01_btn_small_ghost.png'/></a>
