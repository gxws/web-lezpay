	  ...
	  <div class="pa container" style="background-image:url(../static/web-lezpay/images/p62_0001_container.png)">
	  	<!-- begin progress -->
			<div class="pa progress">
				<div class="pa p1 lt" style="background-image:url(../static/web-lezpay/images/p62_0001_p2bg.png)"></div>
			</div>
			<form class="k_form" id="J_k_form">
				<p class="err f18 pa" style="top:126px;left:200px;">错误提示信息区域！</p>
				<div class="f26 pa lftitle" style="top:172px;">新支付密码</div>
				<input class="pa" style="top:162px;left:192px;width:210px;" type="password"/>
				<div class="pa f18" style="top:174px;left:427px;">最少6位,区分大小写</div>
				<div class="f26 pa lftitle" style="top:232px;">确认支付密码</div>
				<input class="pa" style="top:225px;left:192px;width:210px;" type="password"/>
				<img class="pa" style="top:310px;left:190px;" src="../static/web-lezpay/images/k_01_btn_big.png" />
				<div class="f26 pa" style="top:322px;left:250px;">立即设置</div>
