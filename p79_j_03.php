...
<!-- begin x_wrap -->
<div class="x_wrap pa j_wrap" style="background-image:url(../static/web-lezpay/images/bg_x_0001_p67_6.jpg);">

	<!-- begin x_date -->
	<div class="x_date pa">{05月09日}</div>
	<div class="user_id pa fs20">
		<div class="pa icon"><img src="../static/web-lezpay/images/0002_user_icon_03.jpg" alt="" /></div>
		<div class="pa ids">13807818631</div>
	</div>
	<!-- end x_date -->
	...
	<!-- begin x_btns -->
	<a href="javascript:;" class="btnss x_btn_1 pa"><img src="../static/web-lezpay/images/x_btn_1.png" /></a>
	<a href="javascript:;" class="pa my_info_btns"><img src="../static/web-lezpay/images/0001_my_info_btn.png" alt="" /></a>
	<!-- end x_btns -->
