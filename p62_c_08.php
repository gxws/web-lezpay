	...
	<div class="">
	  ...
	  <div class="header auto" style="background-image:url(../static/web-lezpay/images/p62_0001_header.png)">
	  	...
	  	<div class="pa title_bx add">
	  		...
	  		<div class="pa cont lg" style="background-image:url(../static/web-lezpay/images/p62_0001_titlecont.png)"><!-- md类常用宽度,lg类加长宽度 -->
		  		<em class="pa fs22 tc">快捷支付银行卡</em>
	  ...
	  <div class="pa container c_p62slelists">
			<div class="pa tips">
				...
				<div class="pa lis">没有银行卡，请添加！</div>
			</div>
			<div class="pa page"><span>2</span>/5</div>
			<!-- begin addcard_bx 添加银行卡-->
			<div class="pa addcard_bx">
				<a href="p62_c_09.php" class="pa add_deposit"><img src="../static/web-lezpay/images/p62_0001_addcard1.png" alt="" width="140" height="40"/></a>
